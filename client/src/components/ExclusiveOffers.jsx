        ...
        <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-32'>
            <div className='flex flex-col md:flex-row items-center justify-between w-full'>
                <Title
                    ...
                    subTitle="Take advantage of our limited-time deals and enjoy exclusive discounts on top-rated hotels across the globe. Your dream stay is now more affordable than ever!"
                />
